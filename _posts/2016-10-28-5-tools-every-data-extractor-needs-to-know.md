...
2. Data should be available and open.
When you don’t know where to find data, especially extractives data, use one of the many existing open data portals out there. Trust me, there are many fish in the sea.

Here’s a short list:
– EITI.org – for data disclosed in EITI reports from 49 countries as of 2015.
